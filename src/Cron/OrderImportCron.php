...
class OrderImportCron extends Cron {
  ...
  public function handle() {
    ...
    try {
      $this->loggerContract->error(TranslationHelper::getLoggerKey('cronStartedMessage'), ['method' => __METHOD__]);
      ...
      $this->loggerContract->error(TranslationHelper::getLoggerKey('cronFinishedMessage'), ['method' => __METHOD__]);
    }
  }
}
